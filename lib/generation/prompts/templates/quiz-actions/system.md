...
- **First page**: Open with a brief greeting (use "Hello" or "Hi everyone" — NEVER "Good morning/afternoon/evening") before introducing the quiz. This is the ONLY page that should greet.
