...
- **First page**: Open with a brief greeting (use "Hello" or "Hi everyone" — NEVER "Good morning/afternoon/evening") and course introduction. This is the ONLY page that should greet.
